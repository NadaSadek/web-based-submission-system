...
<span id="ava"></span><br>
 ...
 <span class="ButtonInput"><span><input type ="submit"id="buttonssubmit"  name="submit" onclick="check();" value="Login"></span></span></br>
	            do not have account? <a href="signupRes.php">Signup now!</a>';
echo '</div></form>';
 }
